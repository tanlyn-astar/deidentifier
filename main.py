...
for filename in sorted(os.listdir(input_folder)):
    ...
    for report in reports:
        ...
        rows.append(row)
        all_rows.append(row)
        tracker_rows.append({"Id": report_id, "Filename": filename, "Reports in file": len(reports), "Reviewed by": "", "Status": "", "Comments": ""})
        report_id += 1
...
tracker_df = pd.DataFrame(tracker_rows, columns=["Id", "Filename", "Reports in file", "Reviewed by", "Status", "Comments"])
